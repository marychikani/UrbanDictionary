...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_search.setOnClickListener{
            ...
            mActivityModel.getDictionaryData(word_to_search.text.toString().trim())
    ...
    fun setupRecyclerView(data: List<ListObject>){
        ...
        if (adapter == null) {
            ...
            recycler_dictionary.setLayoutManager(LinearLayoutManager(this,RecyclerView.VERTICAL, false))

            recycler_dictionary.setAdapter(adapter)
           recycler_dictionary.setItemAnimator(DefaultItemAnimator())
            recycler_dictionary.setNestedScrollingEnabled(true)
        } else {
